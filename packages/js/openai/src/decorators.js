...
import { reassign, OPENAI_KEY_MAPPING, OPENAI_STARTING_INDICES } from './mapping.js';

let _logApiUrl = DEFAULT_API_URL;
let _keyToCvs = { ...OPENAI_KEY_MAPPING };
let _startingIndices = { ...OPENAI_STARTING_INDICES };
